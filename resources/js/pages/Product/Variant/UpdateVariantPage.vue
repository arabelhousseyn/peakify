    ...
    methods : {
        ...
        update()
        {
            ...
            axios.get('/sanctum/csrf-cookie').then(res => {
                axios.put(`/api/product/variants/update/${this.product_offer_id}`,this.infos).then(e=>{
                    this.$toast.open({
        ...
        init()
        {
            this.disable = true
            axios.get('/sanctum/csrf-cookie').then(res => {
                axios.get(`/api/product/variants/details/${this.product_offer_id}`).then(e=>{
