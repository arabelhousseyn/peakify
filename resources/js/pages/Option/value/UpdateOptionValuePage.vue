<template>
    <div class="update-option-value-page">
        <v-container fluid>
...
export default {
    props : ['data'],
    data : ()=>({
        option_value_id : window.location.href.split('/').pop(),
        items : [
            {
    ...
    methods : {
        ...
        update()
        {
            ...
            axios.get('/sanctum/csrf-cookie').then(res => {
                axios.put(`/api/option/update-option-value/${this.option_value_id}`,this.infos).then(e=>{
                    this.$toast.open({
        ...
        init()
        {
            this.disable = true
            axios.get('/sanctum/csrf-cookie').then(res => {
                axios.get(`/api/option/option-value-details/${this.option_value_id}`).then(e=>{
